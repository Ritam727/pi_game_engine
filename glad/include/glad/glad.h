/*
    ...
    OpenGL loader generated by glad 0.1.36 on Sat Oct 25 10:00:19 2025.
...
typedef void *(*GLADloadproc)(char const *name);
...
typedef void(APIENTRY *GLDEBUGPROCAMD)(GLuint id, GLenum category,
                                       GLenum severity, GLsizei length,
                                       GLchar const *message, void *userParam);
...
typedef void(APIENTRYP PFNGLBINDFRAGDATALOCATIONINDEXEDPROC)(
    GLuint program, GLuint colorNumber, GLuint index, GLchar const *name);
...
typedef void(APIENTRYP PFNGLSPECIALIZESHADERPROC)(
    GLuint shader, GLchar const *pEntryPoint, GLuint numSpecializationConstants,
