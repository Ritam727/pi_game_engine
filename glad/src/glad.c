...
PFNGL_CALLLISTPROC                   glad_GL_CALLList = NULL;
PFNGL_CALLLISTSPROC                  glad_GL_CALLLists = NULL;
...
static void                        load_GL_VERSION_1_0(GLADloadproc load) {
  ...
  glad_GL_CALLList = (PFNGL_CALLLISTPROC) load("GL_CALLList");
  glad_GL_CALLLists = (PFNGL_CALLLISTSPROC) load("GL_CALLLists");
